<div class="gureinfo">
	<form id='kontualdatu' class='pure-form' action="" method='post'>
		...
		<input class='pure-input-1-6' type="text" required maxlength='30' placeholder='<?php echo $erabObj->abizena ?>' name='abizena'>
		<input class='pure-input-1-6' type="email" required maxlength='40' placeholder='<?php Session::get('email'); ?>' name='email'>
		</fieldset>
		<fieldset class='pure-group'>
		<input class='pure-input-1-6' type="number" required max='999999999999' placeholder='<?php echo $erabObj->telefonoa ?>' name='telefono'>
		<input class='pure-input-1-6' type="text" required maxlength='70' placeholder='<?php echo $erabObj->helbidea ?>' name='helbidea'>
		</fieldset>
