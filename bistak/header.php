...
<?php } ?><?php if(Sartu::adminBarruan()) { ?>
	<li><a href="index.php?ekintza=kudeatzaile_prod" class="tooltip ikono" title='<ul class="kategoriak"><li><a href="index.php?ekintza=kudeatzaile_prod"><i class="fa fa-cubes"></i>  Produktuak</a></li>
									...
									</ul>' href="index.php?ekintza=kudeatzaile_prod"><li><img id='adminarg' src="public/img/admin.png" style="height:25px;" alt="Karritoan duzuna ikusi"></a></li>
